...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username == 'TUinti' && $password == 'inti123') {
...
@media only screen and (max-width: 576px) {
    .login-wrapper {
        padding: 20px; /* Memberikan padding tambahan pada wrapper */
    }

    .bkn-logo {
        width: 80px; /* Mengurangi ukuran logo untuk perangkat kecil */
    }

    .login-container {
        padding: 20px; /* Mengurangi padding pada container */
    }
}
.login-wrapper {
    display: flex;
    ...
    align-items: center;
    justify-content: center;
    height: 100vh; /* Menjaga agar halaman tetap terpusat */
}
